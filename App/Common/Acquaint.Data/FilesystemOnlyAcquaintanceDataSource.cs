...
namespace Acquaint.Data
{
	...
	public class FilesystemOnlyAcquaintanceDataSource : IDataSource<Acquaintance>
	{
		...
		static List<Acquaintance> GenerateAcquaintances()
		{
			...
			{
				new Acquaintance() { Id = "00004363-F79A-44E7-BC32-6128E2EC8401", FirstName = "Pierre", LastName = "Lagarde", Company = "GG Mechanical", JobTitle = "Vice President", Email = "jgrimes@ggmechanical.com", Phone = "414-367-4348", Street = "2030 Judah St", City = "San Francisco", PostalCode = "94144", State = "CA", PhotoUrl = "https://acquaint.blob.core.windows.net/images/josephgrimes.jpg" },
